...
//        FirefoxOptions options = new FirefoxOptions()
                //.addArguments("user-data-dir=" + pathProfile); // TODO
                //.setBinary("C:\\Windows\\System32\\calc.exe");
                // .setBinary("c:/Program Files/Nightly/firefox.exe")
...
//               WebDriver driver = new FirefoxDriver(capabilities);
   ...
   // @Test // ignore-certificate-errors Now, NOT Work by default!!!
    public void testChrome2_1Certificate() throws Exception {
        ...
        // options.addArguments("--no-sandbox");
        // options.addArguments("--disable-web-security");
        options.addArguments("--ignore-certificate-errors"); // NOT Work by default!!!
        // options.addArguments("--disable-extensions");
    ...
    public void testChrome3UserProfile() throws Exception {
        ...
        //String userProfile = System.getenv("HOMEPATH") + "\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1";
    ...
    // Use Selenium 4.7.1; Do not use Selenium 4.8.3
//    @Test
    ...
    public void createService() throws Exception {
        service = new ChromeDriverService.Builder()
                ...
                .usingDriverExecutable(new File(
                        System.getenv("HOMEPATH") + "\\.cache\\selenium\\chromedriver\\win32\\111.0.5563.64\\chromedriver.exe"))
